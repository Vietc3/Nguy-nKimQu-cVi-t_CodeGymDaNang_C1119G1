...
@NgModule({
  ...
  imports: [RouterModule.forRoot(routes),MatSnackBarModule, CommonModule, Ng2SearchPipeModule, FormsModule, NgxPaginationModule, ReactiveFormsModule, MatDialogModule, MatIconModule, MatButtonModule],
